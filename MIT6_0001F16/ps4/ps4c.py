...
class SubMessage(object):
    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        for index in range(len(VOWELS_LOWER)):
            transpose_dict[VOWELS_LOWER[index]] = \
                vowels_permutation[index].lower()
            transpose_dict[VOWELS_UPPER[index]] = \
                vowels_permutation[index].upper()
    ...
    def apply_transpose(self, transpose_dict):
        ...
        for letter in self.message_text:
            message_text_encrypted += transpose_dict.get(letter, letter)
...
if __name__ == '__main__':
    ...
    message_2 = SubMessage("Do you know me?")
    permutation_2 = "ouaei"
    enc_dict_2 = message.build_transpose_dict(permutation_2)
    print("Original message:", message_2.get_message_text(), "Permutation:",
          permutation_2)
    print("Expected encryption:", "De yei knew mu?")
